    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Assign links to individual users with advanced search</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <SearchableDropdown
                ...
                placeholder={selectedCategory ? `Search links in ${selectedCategory}...` : "First select a category or search all links..."}
                displayKey="name"
                valueKey="id"
                searchKey="name"
                required={true}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm text-blue-800">
                  <strong>Ready to assign:</strong> {linksList.find(l => l.id === selectedLink)?.title} 
                          ...
                          <div key={link.id} className="bg-gray-50 p-3 rounded-lg border">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <h6 className="font-medium text-gray-900 text-sm mb-1">{link.title}</h6>
                ...
                <div key={linkAssignment.link.id} className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {linkAssignment.users.map(user => (
                      <div key={user.id} className="flex items-center bg-gray-50 px-3 py-2 rounded-lg border">
